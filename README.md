...
这种功能性的项目很实用但是往往也很枯燥，没有音乐播放器那么看起来绚丽，思来想去发现饿了么是一个不错的素材，一来它足够复杂，开放的外卖平台比一般的公司独有商铺更加复杂。二来 见到那么多美食，大家也不会感觉到厌烦。我会用反向代理来解决跨域问题，直接使用饿了么的官方数据，而不是本地模拟数据，不过必须在pc端打开。
