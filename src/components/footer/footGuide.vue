    ...
    >
      <defs>
        ...
        <symbol xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" id="msiteActive">
          <defs>
            ...
            <linearGradient id="index.18edf5a_d" x1="50%" x2="50%" y1="100%" y2="0%">
              <stop offset="0%" stop-color="#29ADFF" />
              <stop offset="100%" stop-color="#0095FF" />
            </linearGradient>
            <path
              id="index.18edf5a_a"
            ...
            <mask id="index.18edf5a_e" width="9.455" height="10.456" x="-1" y="-1">
              <path fill="#fff" d="M29.426 18.382h9.455v10.456h-9.455z" />
              <use xlink:href="#index.18edf5a_a" />
            </mask>
            <path
              id="index.18edf5a_b"
            ...
            <mask id="index.18edf5a_f" width="38.769" height="39.241" x="-.7" y="-.7">
              <path fill="#fff" d="M-.521-.675h38.769v39.241H-.521z" />
              <use xlink:href="#index.18edf5a_b" />
            </mask>
          </defs>
          <g fill="none" fill-rule="evenodd">
            <g transform="translate(1 1)">
              <use fill="url(#index.18edf5a_c)" xlink:href="#index.18edf5a_a" />
              <use
            ...
            <g transform="translate(1 1)">
              <use fill="url(#index.18edf5a_c)" xlink:href="#index.18edf5a_b" />
              <use
                stroke="url(#index.18edf5a_d)"
                stroke-width="1.4"
        ...
        <symbol xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" id="find">
          <defs>
            ...
            <mask id="discover-regular.8ef537f_b" width="40" height="40" x="0" y="0" fill="#fff">
              <use xlink:href="#discover-regular.8ef537f_a" />
            </mask>
          </defs>
          <g fill="none" fill-rule="evenodd">
            <use
        ...
        <symbol xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 38 38" id="order">
          <defs>
            <rect id="order-regular.41c17f8_a" width="38" height="38" rx="2" />
            <mask id="order-regular.41c17f8_b" width="38" height="38" x="0" y="0" fill="#fff">
              <use xlink:href="#order-regular.41c17f8_a" />
            </mask>
          </defs>
          <g fill="none" fill-rule="evenodd">
            <use
        ...
        <symbol viewBox="0 0 38 38" id="orderActive">
          ...
          <g fill="none" fill-rule="evenodd">
            <rect width="38" height="38" fill="url(#order.070ae2a_a)" rx="2" />
        ...
        <symbol xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 38 38" id="profile">
          <defs>
            ...
            <mask id="profile-regular.c151d62_c" width="18" height="21" x="0" y="0" fill="#fff">
              <use xlink:href="#profile-regular.c151d62_a" />
            </mask>
            <path
            ...
            <mask id="profile-regular.c151d62_d" width="38" height="16" x="0" y="0" fill="#fff">
              <use xlink:href="#profile-regular.c151d62_b" />
            </mask>
          </defs>
          <g fill="none" fill-rule="evenodd" stroke="#666" stroke-width="4">
            <use mask="url(#profile-regular.c151d62_c)" xlink:href="#profile-regular.c151d62_a" />
            <use mask="url(#profile-regular.c151d62_d)" xlink:href="#profile-regular.c151d62_b" />
          </g>
        </symbol>
